...
<tr>
  <td width="30%" valign="top">
    <h3>💻 메인페이지</h3>
    <p>내 자산 분포를 미리 볼 수 있고, 다양한 정보를 미리보기 제공합니다.</p>
    <ul>
      <li>도넛 차트로 보는 자산 분포</li>
      <li>커뮤니티 인기글 미리보기</li>
      <li>금융 뉴스, 청년 정책, 금융 상품 미리보기</li>
    </ul>
  </td>
  <td width="60%">
    <img src="https://github.com/user-attachments/assets/74e78527-a649-4a5a-b0d5-2768b8294fb2" alt="메인페이지 데모" width="100%"/>
  </td>
</tr>
<tr>
  <td width="30%" valign="top">
...
- 브랜치 전략 : **git flow 전략**<br>
  저희는 Main 브랜치와 Develop 브랜치, Supporting 브랜치로 구분하였고 Supporting 브랜치는 Feature 브랜치, Design 브랜치로 나눴습니다.
- git commit 규칙 
  - `Feat` : 새로운 기능 추가
  - `Add` : 새로운 파일 추가
  - `Fix` : 버그 수정
  - `Bring` : 원격의 파일을 로컬로 가져왔을 때 커밋해야하는 경우
  - `Refactor` : 코드 리팩토링
  - `Test` : 테스트 코드
  - `Doc` : 문서 수정
...
<table>
  <tr>
    ...
    <td>
      ...
      <p>계획부터 개발 과정까지 적극적으로 임해준 팀원들 덕분에 좋은 프로젝트 경험을 할 수 있었습니다.<br> 
          팀장으로서 프로젝트를 이끌어가며 기술적인 성장뿐만 아니라 리더십과 커뮤니케이션 능력도 향상시킬 수 있었습니다.</p>
    </td>
  </tr>
  <tr>
    <td align="center">
